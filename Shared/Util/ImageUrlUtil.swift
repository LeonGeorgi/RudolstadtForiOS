...
class ImageUrlUtil {
    ...
    static func getThumbUrl(year: Int) -> String {
        ...
        if year >= 2023 && !useApiImageUrl {
            return
                "https://www.rudolstadt-festival.de/files/Bilder/\(year)/Artists/thumbs"
        }
    ...
    static func getFullUrl(year: Int) -> String {
        ...
        if year >= 2023 && !useApiImageUrl {
            return
                "https://www.rudolstadt-festival.de/files/Bilder/\(year)/Artists"
        }
        if year >= 2022 && !useApiImageUrl {
            return
                "https://www.rudolstadt-festival.de/files/Bilder/\(year)/Artists/Thumbs"
    ...
    static func getStreetMusicThumbUrl(year: Int) -> String {
        ...
        if year >= 2023 && !useApiImageUrl {
            return
                "https://www.rudolstadt-festival.de/files/Bilder/\(year)/Stramu/thumbs-stramu"
        }
        if year >= 2022 && !useApiImageUrl {
            return
                "https://www.rudolstadt-festival.de/files/Bilder/\(year)/Stramu"
        }
        return "https://rudolstadt-festival.de/data/\(year)/images/full"
    }
