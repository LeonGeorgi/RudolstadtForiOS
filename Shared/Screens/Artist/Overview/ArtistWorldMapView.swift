...
struct ArtistCountryListRouteView: View {
    ...
    private var flagText: String {
        return emojiFlag(forRegionCode: countryCode) ?? ""
    }
...
private struct WorldMapOverlayAppearance {
...
private struct CountryOverlayMetadata {
    let code: String
}

private struct LoadedWorldCountryMap: @unchecked Sendable {
...
@MainActor
private final class GeoJSONCountryOverlayLoader: ObservableObject {
